...
export default function About(props) {
    ...
    return (
        <div className='container my-5'>
            ...
            <h5 className='mb-3' style={{backgroundColor: props.mode==='dark'?'black':'white', color: props.mode==='dark'?'white':'black'}}>About us</h5>
            ...
            <div>
                <button onClick={toggleThemeColor} className="btn btn-primary mt-3">{btntext}</button>
            </div>
